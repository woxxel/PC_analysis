...
def sample_from_prior_fcn(prior):
  
  ## if input present, simply set function to sample from
  ## if no input, evolve object according to function
  
  
def explore_fcn(obj,logLstar):
  
  # obj       = Object to be evolved
  # logLstar  = minimum loglikelihood of evolved object
  
  N = 100    # N   = step number of MCMC sampling
  #
