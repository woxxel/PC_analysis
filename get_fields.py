...
from utils import pathcat, _hsm, get_nPaths, extend_dict, compute_serial_matrix, corr0, gauss_smooth, get_reliability, get_firingrate
...
class detect_PC:
  ...
  def get_active_Ca(self,S):
    ...
    frate, S_thr, _ = get_firingrate(active['S'],f=self.para['f'])
  ...
  def plt_data(self,n,S=None,results=None,ground_truth=None,activity_mode='calcium',sv=False,suffix=''):
    ...
    rate,S_thr,_ = get_firingrate(S_raw[self.dataBH['active']],f=self.para['f'])
