        ...
        self.sessions = {
            ...
            "246": {
                ...
                "order": [
                    ...
                    range(49, 55),
                    range(43, 46),
                ],  ## achtung!! between 32 & 32 there are 10 measurements missing over 150h
                "analyze": [1, 60],
                "steady": [33, 60],
            },
            "756": {
                "total": 30,  ## super huge gap between 22 & 23
                "order": range(1, 31),
                "analyze": [1, 20],
                "steady": [3, 15],
            },
            "757": {
                "total": 28,  ## super huge gap between 20 & 21
                "order": range(1, 29),
                "analyze": [1, 20],
                "steady": [3, 15],
            },
            ...
            "839": {
                "total": 24,  ## cpp injections starting at 20
                "order": range(1, 25),
                "analyze": [3, 20],
                "steady": [3, 20],
            },
            "840": {
                "total": 25,  ## cpp injections starting at 20
                "order": range(1, 25),
                "analyze": [1, 18],
                "steady": [3, 18],
            },
            "841": {"total": np.nan, "analyze": [np.nan, np.nan]},
            "842": {"total": np.nan, "analyze": [np.nan, np.nan]},
            "879": {
                "total": 15,
                "order": range(1, 16),
                "analyze": [1, 15],
            ...
            "882": {"total": np.nan, "analyze": [np.nan, np.nan]},
            "884": {
                "total": 24,  ## cpp injections starting at 20
                "order": range(1, 25),
                "analyze": [3, 16],
            ...
            "886": {
                "total": 24,  ## saline injections starting at 22
                "order": range(1, 25),
                "analyze": [3, 19],
            },  ## dont know yet
            "549": {
                "total": 29,  ## super huge gap between 20 & 21, kainate acid @ s21
                "order": range(1, 30),
                "analyze": [3, 20],
                "steady": [3, 20],
            },  # bad matching?!
            "551": {
                "total": 28,  ## super huge gap between 20 & 21, kainate acid @ s21
                "order": range(1, 29),
                "analyze": [3, 20],
                "steady": [3, 20],
            },
            "918shKO": {
                "total": 28,  # RW change at s16
                "order": range(1, 29),
                "analyze": [3, 15],
                "steady": [3, 15],
            },
