...
#run_detection('/media/wollex/Analyze_AS3/Data','65',nP,6)
...
run_detection('/media/wollex/Analyze_AS1/linstop','762',nP,2,89,rerun=True)
...
#run_detection('/media/wollex/Analyze_AS1/linstop','232',nP,25)
